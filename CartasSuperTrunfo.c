...
int main()
{
    ...
    comparar_num_pontos_turisticos(nome_a, nome_b, num_pontos_turisticos_a, num_pontos_turisticos_b);
    ...
    comparar_super_poder(nome_a, nome_b, super_poder_a, super_poder_b);
